 ...
 */
public class IRRangeFinderFHS extends AnalogChannel implements PIDSource
{
    ...
    public IRRangeFinderFHS(int slot, int channel)
    {
        super(slot, channel);
    }

    public IRRangeFinderFHS(int channel)
    {
        super(channel);
    }
